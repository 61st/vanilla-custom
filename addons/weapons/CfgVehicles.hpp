...
//////////////////////////////
    ...
    class GVAR(Item_MXM_LXIM): Weapon_Base_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        scopeCurator = 2;
        vehicleClass = "WeaponsPrimary";
        author = "YonV";
        displayName = CSTRING(MXM_LXIM);
...
//////////////////////////////
    ...
    class GVAR(Item_MXC_LXIM): Weapon_Base_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        scopeCurator = 2;
        vehicleClass = "WeaponsPrimary";
        author = "YonV";
        displayName = CSTRING(MXC_LXIM);
...
//////////////////////////////
    ...
    class GVAR(Item_MX_SW_LXIM): Weapon_Base_F {
        dlc = QUOTE(PREFIX);
        scope = 2;
        scopeCurator = 2;
        vehicleClass = "WeaponsPrimary";
        author = "YonV";
        displayName = CSTRING(MX_SW_LXIM);

        class TransportItems {
            class GVAR(MX_SW_LXIM) {
                name = QGVAR(MX_SW_LXIM);
                count = 1;
            };
        };
    };
